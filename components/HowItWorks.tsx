            ...
            <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
              <div className="relative w-full max-w-xs mx-auto">
                ...
                <div className="relative bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-lg">
                  {imageErrors[index] ? (
                    <div className="w-full aspect-[280/580] bg-gradient-to-br from-primary-50 to-primary-100 flex flex-col items-center justify-center p-6">
                      <div className="mb-4">
                      ...
                      <p className="text-primary-900 text-center font-semibold text-sm">Step {step.number}</p>
